...
# ----------------------------
    ...
    st.subheader("AI Doubt Solving Chatbot")
...
# ----------------------------
    ...
    st.subheader("Educational Slides Generator")
...
# ----------------------------
    ...
    st.subheader("Homework Generator")
...
# ----------------------------
    ...
    st.subheader("Concept Diagram Generator")

    topic = st.text_input("Enter Concept")

    if st.button("Draw Diagram"):
